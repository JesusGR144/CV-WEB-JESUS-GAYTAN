  ...
  return (
    <header className="fixed top-0 left-0 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-3 dark:bg-neutral-800 z-50 shadow-md shadow-cyan-400/50 rounded-b-4xl">
      <nav className="max-w-[85rem] w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-between">
        <a className="sm:order-1 flex-none text-xl font-semibold dark:text-white focus:outline-hidden focus:opacity-80" href="#home">Portafolio Web</a>
        <div className="sm:order-3 flex items-center gap-x-2">
          ...
          <button type="button" className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:hover:bg-cyan-700 dark:focus:bg-neutral-700">
            <a href={cvPdf} download>Descargar CV</a>
          </button>
        </div>
